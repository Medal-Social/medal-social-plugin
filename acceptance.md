...
Widget metadata follow-up: #5213 merged as 51dcf27036d6efc4b169a9eb419d497d06a88ed8. Full post-merge test run 35930736913 and staging release 35930737754 passed. Production promotion 35931838620 succeeded through protected release PR #5214, production SHA c53e382f4d1ab357adddbd5c06e10478c59f99c8. ChatGPT tool refresh confirmed ui.domain=https://mcp.medalsocial.com and removed the missing-domain submission warning. Native readback rendered the saved draft in the new mcp-medalsocial-com sandbox; its mobile preview was visually inspected with logo, large heading and hero intact. The iframe-review notice remains expected. Separate Claude staging consent is prepared but still awaits approval for the remaining configured booking tests.

## 24 September production pass and follow-up

Claude connected to real Medal Social with explicit consent. Brand/member/site/traffic reads and a no-change Sanity preview passed. One QA campaign was saved with zero recipients/sends and opened in the builder. It exposed missing brand/footer facts, a duplicate logo, stale context and a Claude preview display error. Google had no locations; production bookings returned a permission refusal. No real booking/member/hours/site writes or email sends were performed.

Monorepo PR #5215 adds guarded cancellation, MCP provenance, content-based brand revisions, native asset-backed logos, persistent footer warnings and host-specific preview metadata. These additions require deployed-server and native-host revalidation before claiming full acceptance. The package remains a release candidate.

Earlier native Claude staging create/move acceptance used only the synthetic demo booking; replay returned the same result and fixture cleanup left no active bookings. This does not certify the new cancellation tool.
