...
Live staging member acceptance now passed: a controlled demo account was added by the existing-user invitation branch exactly once, invitation/role replay matched, admin promotion persisted and the role was restored to member. No invitation token was returned. Demo-domain delivery is suppressed; new-recipient inbox delivery is not certified. Native-host acceptance and an approved connected Google location remain pending, so 1.2.0 is not released.
